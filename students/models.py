...
class Alumno_Preparatoria(models.Model):
	...
	def getCSVLine(s):
		params = (2, #CAMPUS
			...
			'PIN',#Ingreso, Primer_Ingreso_Nivel
			'',#Padre Titulo Trato
			'',#Padre Fallecido
			'',#Padre Nombre
			'',#Padre Ap.Paterno
